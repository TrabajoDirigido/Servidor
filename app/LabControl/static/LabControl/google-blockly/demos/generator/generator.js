...
Blockly.JavaScript['getdouble'] = function(block) {
  return genericGet(block,"float");
};

Blockly.JavaScript['getformula'] = function(block) {
  return genericGet(block,"formula");
};

Blockly.JavaScript['getboolean'] = function(block) {
  return genericGet(block,"boolean");
};

Blockly.JavaScript['getstring'] = function(block) {
  return genericGet(block,"string");
};

Blockly.JavaScript['getobject'] = function(block) {
  return genericGet(block,"object");
};
