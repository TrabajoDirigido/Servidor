...
Blockly.Blocks['get'] = {
  init: function() {
    ...
    var options = [["Double", "float"], ["Boolean", "boolean"], ["String", "string"], ["Formula", "formula"], ["Any", "object"]];
  ...
  updateType_: function(option){
    ...
    if(option == "object")
      this.setPreviousStatement(true, "GETOBJECT");
...
Blockly.Blocks['equal'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Equal");
    this.appendStatementInput("ARG1")
        .setCheck(["COUNT","FILTERCOMPARABLE", "FILTEROBJECT", "GETOBJECT", "GETCOMPARABLE", "GETBOOLEAN", "VAR", "SORT", "EQUAL"])
        .appendField("Arg1");
